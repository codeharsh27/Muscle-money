    ...
    const modules = [
        {
            ...
            difficulty: client_1.LessonDifficulty.BEGINNER,
            estimatedMinutes: 6,
            track: 'Foundations',
            icon: 'shield',
        ...
        },
        {
            ...
            difficulty: client_1.LessonDifficulty.INTERMEDIATE,
            estimatedMinutes: 8,
            track: 'Investing',
            icon: 'chart',
    ...
    for (const item of modules) {
        ...
        await prisma.quiz.upsert({
            ...
            create: {
                ...
                type: client_1.QuizQuestionType.SINGLE_CHOICE,
...
function actionFor(item) {
    if (item.tool === 'savings_calculator') {
        return {
            ...
            description: 'Open PhonePe, Google Pay, Paytm, or your trusted bank app separately. Move a small amount to savings, then return and mark it complete.',
    ...
    const assets = [
        {
            ...
            type: client_1.MarketAssetType.MUTUAL_FUND,
            priceMinor: 25000,
        },
        {
            symbol: 'DIGIGOLD',
            name: 'Digital Gold Simulator',
            type: client_1.MarketAssetType.DIGITAL_GOLD,
            priceMinor: 720000,
        },
        {
            symbol: 'TCS',
            name: 'Tata Consultancy Services Simulator',
            type: client_1.MarketAssetType.STOCK,
            priceMinor: 385000,
        },
    ];
